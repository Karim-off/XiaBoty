...
global.dfail = (type, m, conn) => {
  const msg = {
        rowner: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩',
        owner: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩',
        mods: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩',
        premium: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞𝙚𝙢𝙗𝙧𝙤𝙨 𝙥𝙧𝙚𝙢𝙞𝙪𝙢',
        group: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙚𝙣 𝙜𝙧𝙪𝙥𝙤𝙨',
        private: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙚𝙣 𝙘𝙝𝙖𝙩 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩',
        admin: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚𝙣 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙧 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤',
        botAdmin: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙓𝙞𝙖 𝘽𝙤𝙩 𝙖𝙙𝙫𝙞𝙚𝙧𝙩𝙚 𝙦𝙪𝙚 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨 𝙣𝙚𝙘𝙚𝙨𝙖𝙧𝙞𝙤 𝙦𝙪𝙚 𝙚𝙡 𝙗𝙤𝙩 𝙨𝙚𝙖 𝙖𝙙𝙢𝙞𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤',
        unreg: '🔮 𝙓𝙄𝘼 𝘽𝙊𝙏 𝙏𝙀 𝘼𝙑𝙄𝙎𝘼 𝙌𝙐𝙀 𝙉𝙊 𝙀𝙎𝙏𝘼𝙎 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝘿𝙊 🔮\n\n*—◉ 𝙿𝙰𝚁𝙰 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙳𝙴𝙱𝙴𝚂 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚃𝙴, 𝚄𝚂𝙰 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾*\n*➣ /reg nombre.edad*',
        restrict: '[ 🔮 𝘼𝙇𝙀𝙍𝙏𝘼 🔮 ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂𝚃𝙰 𝚁𝙴𝚂𝚃𝚁𝙸𝙽𝙶𝙸𝙳𝙾/𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝙳𝙾 𝙿𝙾𝚁 𝙳𝙴𝚂𝙸𝙲𝙸𝙾𝙽 𝙳𝙴𝙻 𝙿𝚁𝙾𝙿𝙸𝙴𝚃𝙰𝚁𝙸𝙾/𝙰 (𝙾𝚆𝙽𝙴𝚁) 𝙳𝙴𝙻 𝙱𝙾𝚃'
         }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '🔮 𝘼𝙑𝙄𝙎𝙊 - 𝘼𝙇𝙀𝙍𝙏𝘼', body: '𝙓𝙞𝙖𝘽𝙤𝙩-𝙈𝘿', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/usxr_angelito'}}}}, aa);
